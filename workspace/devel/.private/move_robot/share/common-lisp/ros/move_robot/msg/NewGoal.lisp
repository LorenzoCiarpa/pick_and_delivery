...
(cl:defmethod cl:initialize-instance :after ((m <NewGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NewGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name move_robot-msg:<NewGoal> is deprecated: use move_robot-msg:NewGoal instead.")))
...
(cl:defmethod theta-val ((m <NewGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader move_robot-msg:theta-val is deprecated.  Use move_robot-msg:theta instead.")
  (theta m))
